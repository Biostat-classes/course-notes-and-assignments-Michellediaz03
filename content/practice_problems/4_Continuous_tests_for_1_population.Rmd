...
*I found a test statistics of z\~=0.33 .This corresponds to a p-value of
0.73. This p value is \>.05, so I fail to reject the null hypothesis
...
*I found a test statistics of V=40.5. This corresponds to a p-value of
0.20. This p-value is \>.05, so I fail to reject the null hypothesis
that the population mean is equal to 205.*
